...
export function AuthProvider({ children }: { children: ReactNode }) {
    ...
    const login = async (
        ...
        try {
            ...
            return (
                errorMsg || "Login gagal. Periksa kembali email dan password."
            );
        }
    };
    ...
    const exchangeAndLogin = async (code: string): Promise<string | null> => {
        try {
            ...
            const errorMsg = error.response?.data?.message;
            return (
                errorMsg || "Sesi OAuth kadaluwarsa, silakan login ulang."
            );
        }
    };
    ...
    const register = async (
        ...
        try {
            ...
            const errorMsg = error.response?.data?.message;
            return (
                errorMsg || "Registrasi gagal. Coba gunakan email lain."
            );
        }
    };
    ...
    if (isLoading) {
        return (
            <div className="relative min-h-screen w-full bg-[#06050E] text-slate-100 overflow-hidden flex items-center justify-center font-sans select-none">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[70vw] h-[70vw] max-w-[500px] max-h-[500px] rounded-full blur-[100px] bg-[#1d4ed8]/[0.08] pointer-events-none z-0 animate-pulse" />
                ...
                <div className="relative z-10 flex flex-col items-center gap-6">
                    ...
                    <div className="relative w-20 h-20 flex items-center justify-center">
                        ...
                        <div className="absolute inset-0 rounded-full border-2 border-[#1d4ed8]/20 border-t-[#1d4ed8] animate-spin" />
                    ...
                    <div className="flex flex-col items-center gap-1 text-center">
                        <span className="font-mono text-[10px] tracking-[0.25em] text-[#2563eb] uppercase">
                            AUTHENTICATING
                        </span>
