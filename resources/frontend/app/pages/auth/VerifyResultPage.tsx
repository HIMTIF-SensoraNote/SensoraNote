                ...
                <div className="text-center mb-10">
                    ...
                    <div className="space-y-4">
                        ...
                        <button
                            ...
                            className="w-full bg-primary hover:bg-blue-700 text-white py-4 rounded-xl font-['Lexend_Deca'] font-bold text-[15px] shadow-lg shadow-blue-600/20 hover:shadow-xl hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2"
                        >
