                ...
                <div className="w-full max-w-md mx-auto">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="w-full pl-9 pr-4 py-3.5 bg-gray-50 dark:bg-[#1C1A29] border border-gray-200 dark:border-white/10 rounded-2xl font-['Manrope'] text-[15px] text-gray-900 dark:text-gray-100 transition-all focus:bg-white dark:focus:bg-[#252336] focus:outline-none focus:ring-4 focus:ring-blue-100 dark:focus:ring-blue-500/10 focus:border-blue-500 placeholder:text-slate-500 dark:placeholder:text-slate-400"
                                    placeholder="johndoe"
                                    required
                                />
                            </div>
                        ...
                        <button
                            ...
                            className={`w-full bg-primary hover:bg-blue-700 text-white py-4 rounded-full font-['Lexend_Deca'] font-bold text-[15px] shadow-lg shadow-blue-600/20 hover:shadow-xl hover:shadow-blue-600/30 hover:-translate-y-0.5 transition-all active:scale-[0.98] mt-8 flex items-center justify-center gap-2 ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
                        >
                            {isSubmitting ? (
                                <>
