...
export const mataPelajaran = [
  ...
  { id: 'bahasa-inggris', name: 'Bahasa Inggris', icon: '🇬🇧', color: '#2563eb', category: 'Umum & Bahasa' },
  ...
  { id: 'astronomi', name: 'Astronomi', icon: '🔭', color: '#2563eb', category: 'Sains & Matematika' },
  ...
  { id: 'psikologi', name: 'Psikologi', icon: '🧠', color: '#2563eb', category: 'Sosial & Humaniora' },
  ...
  { id: 'seni-musik', name: 'Seni Musik', icon: '🎵', color: '#2563eb', category: 'Seni, Olahraga & Desain' },
  ...
  { id: 'sinematografi', name: 'Sinematografi', icon: '🎬', color: '#2563eb', category: 'Seni, Olahraga & Desain' },
  { id: 'arsitektur', name: 'Arsitektur', icon: '🏛️', color: '#46F080', category: 'Seni, Olahraga & Desain' },

  // Teknologi & Komputer
  { id: 'informatika', name: 'Informatika', icon: '💻', color: '#2563eb', category: 'Teknologi & Komputer' },
  ...
  { id: 'os', name: 'Sistem Operasi', icon: '⚙️', color: '#2563eb', category: 'Teknologi & Komputer' },
  ...
  { id: 'keperawatan', name: 'Ilmu Keperawatan', icon: '🏥', color: '#2563eb', category: 'Kesehatan & Medis' },
  ...
  { id: 'mekanika', name: 'Mekanika Teknik', icon: '⚙️', color: '#2563eb', category: 'Teknik & Kejuruan' },
  ...
  { id: 'pelayaran', name: 'Ilmu Pelayaran', icon: '🚢', color: '#2563eb', category: 'Teknik & Kejuruan' },
  ...
  { id: 'perikanan', name: 'Ilmu Perikanan', icon: '🐟', color: '#2563eb', category: 'Pertanian & Alam' },
  ...
  { id: 'manajemen', name: 'Manajemen', icon: '📋', color: '#2563eb', category: 'Bisnis & Komunikasi' },
